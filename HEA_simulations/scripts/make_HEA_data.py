...
if __name__ == '__main__':
    ...
    for data_index in range(first_number, num_data):
        ...
        if ATK_structure:
            ...
            if comp is not 'random':
                ...
                assert len(chemical_symbols) == len(comp), '{} fractions are required for {} chemical symbols'.format(len(chemical_symbols),len(chemical_symbols))

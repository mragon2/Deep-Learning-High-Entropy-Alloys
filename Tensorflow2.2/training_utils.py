...
def save_epoch_results(training_results_folder_path,
    ...
    plot_learning_curves(np.array(train_loss_learning_curve),
                         ...
                         path = os.path.join('../',training_results_folder_path))
...
def train(results_folder_path,
    ...
    training_data_folder_path = os.path.join(data_folder_path,'training_data/data/')
    test_data_folder_path = os.path.join(data_folder_path,'test_data/data/')
